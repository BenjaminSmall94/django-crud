...
class SnacksTests(TestCase):
    def setUp(self):
        ...
        self.snack = Snack.objects.create(title="butterfingers", purchaser=self.user, description="Test")

    def test_string_representation(self):
        self.assertEqual(str(self.snack), "butterfingers")
    ...
    def test_snack_list_content(self):
        ...
        self.assertEqual(snacks[0].title, "butterfingers")
    ...
    def test_snack_detail_content(self):
        ...
        self.assertEqual(snack.title, "butterfingers")
